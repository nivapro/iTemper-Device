...
import { init as initSensors } from './client-sensors';
import { init as initSettings, registerBrowserSetting, Setting } from './client-settings';
...
function init() {
    initMenu();
    registerBrowserSetting('COLOR', updateBrowser)
    initSensors();
    initSettings();
    initConnection();
